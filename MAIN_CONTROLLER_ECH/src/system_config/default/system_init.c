 ...
 *
 ********************************************************************/
extern int BOARD_ID_SETTING;
extern unsigned int MY_IP_ADDR[4];
...
SYS_MODULE_OBJ TCPIP_STACK_Init()
{
    ...
    char tempAddr[128];// = "192.168.1.178";
    char tempGate[128];// = "192.168.1.1";
...
//    MY_IP_ADDR[0] = MEM_Read(0);
//    MY_IP_ADDR[1] = MEM_Read(1);
//    MY_IP_ADDR[2] = MEM_Read(2);
//    MY_IP_ADDR[3] = MEM_Read(3);
    // ------------------------------------------
...
//    if(BOARD_ID_SETTING == 3){
//        // default setting
//        sprintf(tempAddr, "192.168.1.3");
//        sprintf(tempGate, "192.168.1.1");
//    }else if(BOARD_ID_SETTING == 2){
//        // default setting
//        sprintf(tempAddr, "192.168.1.2");
//        sprintf(tempGate, "192.168.1.1");
//    }else if(BOARD_ID_SETTING == 1){
//        // default setting
//        sprintf(tempAddr, "192.168.1.1");
//        sprintf(tempGate, "192.168.1.1");
//    }else{
//        // saved setting
//        sprintf(tempAddr, "%d.%d.%d.%d", MY_IP_ADDR[0], MY_IP_ADDR[1], MY_IP_ADDR[2], MY_IP_ADDR[3]);
//        sprintf(tempGate, "%d.%d.%d.1", MY_IP_ADDR[0], MY_IP_ADDR[1], MY_IP_ADDR[2]);
//    }
    
    
    sprintf(tempAddr, "192.168.100.120");
